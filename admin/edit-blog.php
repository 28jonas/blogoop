    ...
    <div class="card">
        ...
        <div class="card-content">
            <div class="card-body row">
                ...
                <form class="form form-vertical col-6" action="edit-blog.php?id=<?= $blog->id; ?>" method="post" enctype="multipart/form-data">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" class="form-control"
                                           name="title" placeholder="title" value="<?= $blog->title; ?>">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label id="description" for="description">Description</label>
                                    <textarea style="text-align:left;" class="form-control" name="description" id="default" rows="5" cols="100%" placeholder="description"><?= trim($blog->description) ?></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
